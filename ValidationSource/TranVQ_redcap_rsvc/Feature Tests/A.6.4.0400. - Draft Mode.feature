Feature: A.6.4.0400. Manage project creation, deletion, and settings. Control Center: The system shall allow production Draft Mode changes to be approved automatically under certain conditions.
  ...
  Scenario: A.6.4.0400.100 User's ability to approve draft changes without administrative approval
    ...
    When I enter "DM@oucru.org" into the input field labeled "Email Address of REDCap Administrator"
  ...
  | mm/dd/yyyy hh:mm | tranvq_adminuser | Manage/Design | Move project to Production status       |
    ...
    Then I should see a table header and rows containing the following values in the logging table:
      | Time / Date      | Username   | Action        | List of Data Changes OR Fields Exported |
  | mm/dd/yyyy hh:mm | tranvq_testuser1 | Manage/Design | Enter draft mode                        |
    ...
    Then I should see a table header and rows containing the following values in the logging table:
      | Time / Date      | Username   | Action        | List of Data Changes OR Fields Exported               |
  | mm/dd/yyyy hh:mm | tranvq_testuser1 | Manage/Design | Request approval for production project modifications |
    ...
    Then I should see a table header and rows containing the following values in the logging table:
      | Time / Date      | Username   | Action        | List of Data Changes OR Fields Exported |
  | mm/dd/yyyy hh:mm | tranvq_adminuser | Manage/Design | Reject production project modifications |
  ...
  | mm/dd/yyyy hh:mm | tranvq_testuser1 | Manage/Design | Request approval for production project modifications |
    ...
    Then I should see a table header and rows containing the following values in the logging table:
      | Time / Date      | Username   | Action        | List of Data Changes OR Fields Exported  |
  | mm/dd/yyyy hh:mm | tranvq_adminuser | Manage/Design | Approve production project modifications |
  ...
  Scenario: A.6.4.0400.200 User's ability to approve draft changes without administrative approval if no existing fields were modified
    ...
    Then I should see a table header and rows containing the following values in the logging table:
      | Time / Date      | Username   | Action        | List of Data Changes OR Fields Exported |
  | mm/dd/yyyy hh:mm | tranvq_adminuser | Manage/Design | Remove production project modifications |
    ...
    Then I should see a table header and rows containing the following values in the logging table:
      | Time / Date      | Username   | Action        | List of Data Changes OR Fields Exported              |
  | mm/dd/yyyy hh:mm | tranvq_testuser1 | Manage/Design | Approve production project modifications (automatic) |
  | mm/dd/yyyy hh:mm | tranvq_testuser1 | Manage/Design | Create project field                                 |
