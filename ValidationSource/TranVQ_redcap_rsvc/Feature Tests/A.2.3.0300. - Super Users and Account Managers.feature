Feature: A.2.3.0300. Assign administrators and account managers
    ...
    When I enter "tranvq_testuser1" into the field with the placeholder text of "Search users to add as admin"
    ...
    And I should see "tranvq_testuser1"
    ...
    Given I disable the Administrator Privilege "Access to Control Center dashboards" for the administrator "tranvq_testuser1"
    ...
    And I disable the Administrator Privilege "Install, upgrade, and configure External Modules" for the administrator "tranvq_testuser1"
        And I logout
    And I login to REDCap with the user "tranvq_testuser1"
        When I click on the link labeled "Control Center"
    ...
    Given I disable the Administrator Privilege "Access to all projects and data with maximum user privileges" for the administrator "tranvq_testuser1"
