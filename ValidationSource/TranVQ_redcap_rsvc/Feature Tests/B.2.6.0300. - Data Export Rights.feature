Feature: Project Level:  The system shall allow instrument level data export rights to be (No Access, De-Identified, Remove All Identifier Fields, Full Data Set)
    ...
    Scenario: B.2.6.0300.100 Data Export Rights
        ...
        When I enter "tranvq_testuser1" into the field with the placeholder text of "Assign new user to role"
        ...
        Then I should see a table header and rows containing the following values in a table:
            ...
            | —                       | tranvq_testuser3          |
            | —                       | tranvq_testuser4          |
            | 1_FullRights            | tranvq_testuser1          |
            | 2_Edit_RemoveID         | [No users assigned] |
            | 3_ReadOnly_Deidentified | [No users assigned] |
            | 4_NoAccess_Noexport     | [No users assigned] |

        When I enter "tranvq_testuser2" into the field with the placeholder text of "Assign new user to role"
        And I click on the button labeled "Assign to role"
        ...
        Then I should see a table header and rows containing the following values in a table:
            ...
            | —                       | tranvq_testuser4          |
            | 1_FullRights            | tranvq_testuser1          |
            | 2_Edit_RemoveID         | tranvq_testuser2          |
            | 3_ReadOnly_Deidentified | [No users assigned] |
            | 4_NoAccess_Noexport     | [No users assigned] |

        When I enter "tranvq_testuser3" into the field with the placeholder text of "Assign new user to role"
        And I click on the button labeled "Assign to role"
        ...
        Then I should see a table header and rows containing the following values in a table:
            ...
            | 1_FullRights            | tranvq_testuser1          |
            | 2_Edit_RemoveID         | tranvq_testuser2          |
            | 3_ReadOnly_Deidentified | tranvq_testuser3          |
            | 4_NoAccess_Noexport     | [No users assigned] |

        When I enter "tranvq_testuser4" into the field with the placeholder text of "Assign new user to role"
        And I click on the button labeled "Assign to role"
        ...
        Then I should see a table header and rows containing the following values in a table:
            ...
            | 2_Edit_RemoveID         | tranvq_testuser2          |
            | 3_ReadOnly_Deidentified | tranvq_testuser3          |
            | 4_NoAccess_Noexport     | tranvq_testuser4          |
        And I logout
        ...
        Then I should see a table header and rows containing the following values in the logging table:
            ...
            | tranvq_testuser1 | Data export | Download exported data file (CSV raw)   |
