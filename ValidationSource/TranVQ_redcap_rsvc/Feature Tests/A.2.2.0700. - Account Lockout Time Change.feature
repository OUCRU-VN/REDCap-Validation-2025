Feature: A.2.2.0700. Add/Manage users
    ...
    Given I enter "tranvq_testuser1" into the input field labeled "Username:"
    ...
    Given I attempt to login to REDCap with the user "tranvq_testuser1"
        Then I should see "ACCESS DENIED!"

        #2 minutes of waiting total; now we can login
        Given I wait for another 1 minute
    When I attempt to login to REDCap with the user "tranvq_testuser1"
