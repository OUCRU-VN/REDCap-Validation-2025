Feature: A.2.2.0200 Add/Manage users
  ...
  Scenario: A.2.2.0200.100 Account suspension
    ...
    And I enter "tranvq_testuser1" into the input field labeled "User Search: Search for user by username, first name, last name, or primary email"
    ...
    And I should see a link labeled "tranvq_testuser1"
