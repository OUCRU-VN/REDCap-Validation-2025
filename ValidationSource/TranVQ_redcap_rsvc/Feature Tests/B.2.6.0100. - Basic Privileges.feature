Feature: Project Level: The system shall allow the ability to add, edit or delete user access to application tools for Basic Privileges and expiration date.
    ...
    Scenario: B.2.6.0100.100 Project level User Rights functions (Add, Edit, Expire, Remove)
        ...
        And I enter "tranvq_testuser1" into the input field labeled "Add with custom rights"
        And I click on the button labeled "Add with custom rights"
        Then I should see a dialog containing the following text: "Adding new user"

        When I uncheck the User Right named "Project Design and Setup"
        ...
        Then I should see a table header and rows containing the following values in the logging table:
            ...
            | tranvq_adminuser | Add User | tranvq_testuser1                     |

        ##ACTION #CROSS-FEATURE B.2.23.100: Verify Logging Filter by user name
        When I select the "tranvq_adminuser" option from the Filter by username dropdown field
        ...
        Then I should see "tranvq_testuser1"
        ...
        And I click on the link labeled "tranvq_testuser1"
        ...
        Then I should see a table header and rows containing the following values in the logging table:
            | Username         | Action      | List of Data Changes OR Fields Exported |
            | tranvq_adminuser | Update user | tranvq_testuser1                              |
        Given I logout
        ...
        And I click on the link labeled "B.2.6.0100.100"
        And I click on the link labeled "User Rights"
        And I assign an expired expiration date to user "Test User1" with username of "tranvq_testuser1"
        ...
        And I click on the link labeled "B.2.6.0100.100"
        And I click on the link labeled "User Rights"
        And I remove the expiration date to user "Test User1" with username of "tranvq_testuser1"
        #The Expiration column shows 'never' for "tranvq_testuser1"
        ...
        Then I should see a table header and rows containing the following values in the logging table:
            | Username         | Action      | List of Data Changes OR Fields Exported |
            | tranvq_adminuser | Delete user | tranvq_testuser1                          |
            | tranvq_adminuser | Update user | tranvq_testuser1                          |
        Given I logout
