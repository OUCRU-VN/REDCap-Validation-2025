Feature: B.2.10.0400. User Interface: The system shall provide the ability to restrict a user who has been assigned to a DAG to: (data they entered | data entered by any member of the same DAG | files uploaded in the File Repository)
    ...
    Scenario: B.2.10.0400.100 User restriction for records in DAGs
        ...
        #This will give tranvq_testuser3 elevated privileges for this test
        ...
        #This will give tranvq_testuser4 elevated privileges for this test
        ...
        When I select "tranvq_testuser3 (Test User3)" on the dropdown field labeled "Assign user"
        ...
        Then I should see a table header and rows containing the following values in data access groups table:
            ...
            | TestGroup1         | tranvq_testuser3     |

        When I select "tranvq_testuser1 (Test User1)" on the dropdown field labeled "Assign user"
        When I select "TestGroup1" on the dropdown field labeled "to"
        And I click on the button labeled "Assign"
        ...
        Then I should see a table header and rows containing the following values in data access groups table:
            | Data Access Groups | Users in group       |
            | TestGroup1         | tranvq_testuser1     |
            | TestGroup1         | tranvq_testuser3     |


        When I select "tranvq_testuser4 (Test User4)" on the dropdown field labeled "Assign user"
        ...
        Then I should see a table header and rows containing the following values in data access groups table:
            ...
            | TestGroup1         | tranvq_testuser3     |
            | TestGroup1         | tranvq_testuser1     |
            | TestGroup2         | tranvq_testuser4     |

        When I select "tranvq_testuser2 (Test User2)" on the dropdown field labeled "Assign user"
        When I select "TestGroup2" on the dropdown field labeled "to"
        And I click on the button labeled "Assign"
        ...
        Then I should see a table header and rows containing the following values in data access groups table:
            ...
            | TestGroup1         | tranvq_testuser3     |
            | TestGroup1         | tranvq_testuser1     |
            | TestGroup2         | tranvq_testuser2     |
            | TestGroup2         | tranvq_testuser4     |

        And I logout

        ##VERIFY
        Given I login to REDCap with the user "tranvq_testuser3"
        ...
        Then I should see a table header and rows containing the following values in the logging table:
            ...
            | mm/dd/yyyy hh:mm | tranvq_testuser3   | Create record | record_id = '1-1'                       |
        ...
        Given I login to REDCap with the user "tranvq_testuser4"
        When I click on the link labeled "My Projects"
        And I click on the link labeled "B.2.10.0400.100"
        ...
        ##ACTION: Another user from same DAG has access to same DAG records
        Given I login to REDCap with the user "tranvq_testuser2"
        When I click on the link labeled "My Projects"
        And I click on the link labeled "B.2.10.0400.100"
