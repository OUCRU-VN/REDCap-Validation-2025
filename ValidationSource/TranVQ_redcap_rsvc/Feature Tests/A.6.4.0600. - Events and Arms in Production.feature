Feature: A.6.4.0600 Manage project creation, deletion, and settings. Control Center: The system shall support the option to limit adding or modifying events and arms while in production to administrators. Note: user can add instrument to event in production.
    ...
    Given I login to REDCap with the user "tranvq_adminuser"
        ...
        And I enter "tranvq_testuser1" into the field with the placeholder text of "Assign new user to role"
        And I click on the button labeled "Assign to role"
        And I select "1_FullRights" on the dropdown field labeled "Select Role" on the role selector dropdown
        When I click on the button labeled exactly "Assign" on the role selector dropdown
        Then I should see "tranvq_testuser1" within the "1_FullRights" row of the column labeled "Username" of the User Rights table
        Given I logout
    ...
    Given I login to REDCap with the user "tranvq_testuser1"
        ...
        Then I should see table header and rows containing the following values in the logging table:
            ...
            | tranvq_testuser1 | Manage/Design | Create arm                              |
            | tranvq_testuser1 | Manage/Design | Arm 3: Arm 3                            |
        ...
        Then I should see table header and rows containing the following values in the logging table:
            ...
            | tranvq_testuser1 | Manage/Design | Create arm                                                      |
            | tranvq_testuser1 | Manage/Design | Arm 3: Arm 3                                                    |
            | tranvq_testuser1 | Manage/Design | Create event                                                    |
            | tranvq_testuser1 | Manage/Design | Event: Event 1, Arm: Arm 3, Days Offset: 0, Offset Range: -0/+0 |
        ...
        Then I should see table header and rows containing the following values in the logging table:
            | Username   | Action        | List of Data Changes OR Fields Exported |
            | tranvq_testuser1 | Manage/Design | Edit arm name/number                    |
            | tranvq_testuser1 | Manage/Design | Arm 2: Arm 2                            |
        ...
        Then I should see table header and rows containing the following values in the logging table:
            | Username   | Action        | List of Data Changes OR Fields Exported |
            | tranvq_testuser1 | Manage/Design | Edit event                              |
            | tranvq_testuser1 | Manage/Design | Event One, Arm: Arm 2                   |
        ...
        Then I should see table header and rows containing the following values in the logging table:
            ...
            | tranvq_testuser1 | Manage/Design | Create event                                                    |
            | tranvq_testuser1 | Manage/Design | Event: Event 4, Arm: Arm 1, Days Offset: 4, Offset Range: -0/+0 |
        ...
        Then I should see table header and rows containing the following values in the logging table:
            | Username   | Action        | List of Data Changes OR Fields Exported |
            | tranvq_testuser1 | Manage/Design | Perform instrument-event mappings       |
        ...
        Given I login to REDCap with the user "tranvq_testadmin"
        When I click on the link labeled "My Projects"
        And I click on the link labeled "A.6.4.0600.100"
        And I click on the link labeled "Project Setup"
        ...
        Then I should see table header and rows containing the following values in the logging table:
            | Username   | Action        | List of Data Changes OR Fields Exported                         |
            | tranvq_testuser1 | Manage/Design | Create arm                                                      |
            | tranvq_testuser1 | Manage/Design | Arm 4: Arm 4                                                    |
            | tranvq_testuser1 | Manage/Design | Create event                                                    |
            | tranvq_testuser1 | Manage/Design | Event: Event 1, Arm: Arm 4, Days Offset: 0, Offset Range: -0/+0 |
        ...
        Then I should see table header and rows containing the following values in the logging table:
            | Username   | Action        | List of Data Changes OR Fields Exported |
            | tranvq_adminuser | Manage/Design | Edit arm name/number                    |
            | tranvq_adminuser | Manage/Design | Arm 1: Arm One                          |
        ...
        Then I should see table header and rows containing the following values in the logging table:
            | Username   | Action        | List of Data Changes OR Fields Exported |
            | tranvq_adminuser | Manage/Design | Edit event                              |
            | tranvq_adminuser | Manage/Design | Event Four, Arm: Arm One                |
        ...
        Then I should see table header and rows containing the following values in the logging table:
            | Username   | Action        | List of Data Changes OR Fields Exported |
            | tranvq_adminuser | Manage/Design | Perform instrument-event mappings       |
