Feature: A.2.2.0100. Add/Manage users Control Center - Users: The system shall support the ability create a single unique user with username, first name, last name, primary email, expiration date, and allow the user to create/copy projects.
    ...
    When I enter "tranvq_testuser1" into the input field labeled "Username:"
        And I enter "User1" into the input field labeled "First name:"
        And I enter "Test" into the input field labeled "Last name:"
        And I enter "tranvq@oucru.org" into the input field labeled "Primary email:"
    ...
    And I should see "An email with login information was sent to: tranvq@oucru.org"
        And I logout
    ...
    And I should see "tranvq_testuser2"
    And I should see "tranvq_testuser3"
    And I should see "tranvq_testuser4"
    ...
    And I enter "tranvq_testuser1" into the input field labeled "Username:"
        And I enter "User1" into the input field labeled "First name:"
        And I enter "Test" into the input field labeled "Last name:"
    And I enter "tranvq@oucru.org" into the input field labeled "Primary email:"
        And I click on the button labeled "Save"
    ...
    When I enter "tranvq_testuser1" into the input field labeled "User Search: Search for user by username, first name, last name, or primary email"
