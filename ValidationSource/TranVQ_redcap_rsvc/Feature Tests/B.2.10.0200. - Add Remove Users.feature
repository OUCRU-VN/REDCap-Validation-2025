Feature: B.2.10.0200. User Interface: The system shall support adding and removing users from DAGs.
  ...
  Scenario: B.2.10.0200.100 Assign & Remove User to DAG
    ...
    Then I should see a table header and rows containing the following values in the logging table:
      ...
      | mm/dd/yyyy hh:mm | tranvq_adminuser | Manage/Design | Assign user to data access group        |
      | mm/dd/yyyy hh:mm | tranvq_adminuser | Manage/Design | user = 'tranvq_testuser1'                     |
      | mm/dd/yyyy hh:mm | tranvq_adminuser | Manage/Design | group = 'TestGroup1'                    |
    And I logout
    ...
    Then I should see a table header and rows containing the following values in data access groups table:
      | Data Access Groups        | Users in group                |
      | [Not assigned to a group] | tranvq_testuser1 (Test User1) |
    And I logout
    ...
    Then I should see a table header and rows containing the following values in the logging table:
      | Time / Date      | Username         | Action        | List of Data Changes OR Fields Exported |
      | mm/dd/yyyy hh:mm | tranvq_adminuser | Manage/Design | Remove user from data access group      |
      | mm/dd/yyyy hh:mm | tranvq_adminuser | Manage/Design | user = 'tranvq_testuser1'               |
      | mm/dd/yyyy hh:mm | tranvq_adminuser | Manage/Design | group = 'TestGroup1'                    |
      | mm/dd/yyyy hh:mm | tranvq_adminuser | Manage/Design | Assign user to data access group        |
      | mm/dd/yyyy hh:mm | tranvq_adminuser | Manage/Design | user = 'tranvq_testuser1'               |
