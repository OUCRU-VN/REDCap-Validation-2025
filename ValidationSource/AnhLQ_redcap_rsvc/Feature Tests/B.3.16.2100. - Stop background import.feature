Feature: User Interface: The system shall provide the ability for the user importing data to stop non-imported data during the background data import
    ...
    Scenario: B.3.16.2100.100 Stop non-imported data during the background data import
        ...
        ## And I upload a "csv" format file located at "import_files/BigDataTestProjectDATA.csv", by clicking the button near "Select your CSV data file" to browse for the file, and clicking the button labeled "Upload File" to upload the file -> Wrong csv file name
        And I upload a "csv" format file located at "import_files/BigDataTestProjectDATA2100.csv", by clicking the button near "Select your CSV data file" to browse for the file, and clicking the button labeled "Upload File" to upload the file
